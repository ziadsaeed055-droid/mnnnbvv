      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors">
                <Facebook size={18} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors">
                <Twitter size={18} />
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-lg mb-4 text-gray-800 relative inline-block after:content-[''] after:absolute after:-bottom-2 after:right-0 after:w-12 after:h-1 after:bg-secondary after:rounded-full">
              روابط سريعة
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/consultation" className="text-gray-600 hover:text-primary transition-colors text-sm">استشارة نفسية</Link></li>
              <li><Link to="/quiz" className="text-gray-600 hover:text-primary transition-colors text-sm">اختبر وعيك</Link></li>
              <li><Link to="/freshman-guide" className="text-gray-600 hover:text-primary transition-colors text-sm">دليل الطالبة الجديدة</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-sm text-gray-600">
                ...
                <span>جامعة بني سويف التكنولوجية، المبنى الإداري، الدور الثاني</span>
              </li>
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500 text-center md:text-right">
            © 2024 وحدة مناهضة العنف ضد المرأة - جامعة بني سويف التكنولوجية. جميع الحقوق محفوظة.
          </p>
