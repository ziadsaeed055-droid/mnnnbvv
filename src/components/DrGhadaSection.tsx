          ...
          <ScrollReveal direction="right">
            <div className="relative flex justify-center">
              ...
              <div className="relative">
                ...
                <img
                  src={drGhada}
                  alt="د. غادة توفيق - رئيسة الوحدة"
                  className="relative w-72 h-80 md:w-80 md:h-96 object-cover rounded-2xl shadow-2xl z-10 border-4 border-white dark:border-border"
                />
                {/* Name badge */}
                <motion.div
                  ...
                  className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-gradient-brand text-white px-6 py-2.5 rounded-full shadow-xl z-20 whitespace-nowrap"
                >
                  <p className="text-sm font-bold">د. غادة توفيق</p>
                </motion.div>
              </div>
            </div>
          </ScrollReveal>
            ...
            <div className="space-y-6">
              <div>
                <div className="flex items-center gap-2 text-primary font-bold mb-2">
                  ...
                  <span>رئيسة الوحدة</span>
                </div>
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-2">
                  الدكتورة <span className="text-gradient-brand">غادة توفيق</span>
                </h2>
                <p className="text-muted-foreground leading-relaxed">
                  رئيسة وحدة تكافؤ الفرص ومناهضة العنف ضد المرأة بجامعة بني سويف التكنولوجية، ورئيسة مركز UICC.
                  أستاذة متميزة تُدرّس اللغة الإنجليزية وتؤمن بقوة التعليم في تغيير المجتمعات.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  <motion.div
                    ...
                    className="bg-muted/30 border border-border rounded-xl p-4 hover:shadow-md transition-shadow"
                  >
              ...
              <blockquote className="border-r-4 border-primary pr-4 py-2 bg-accent/50 rounded-l-xl">
                <p className="text-sm text-foreground italic leading-relaxed">
                  "إيمانًا بأن التعليم والتوعية هما أساس التغيير، نعمل جميعًا من أجل بيئة جامعية آمنة وعادلة تدعم الجميع."
                </p>
                <p className="text-xs text-muted-foreground mt-1">— د. غادة توفيق</p>
              </blockquote>
            </div>
          </ScrollReveal>
        </div>
